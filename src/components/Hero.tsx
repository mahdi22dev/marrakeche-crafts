  ...
  return (
    <section style={{ backgroundColor: "var(--raw-linen)" }}>
      <div className="grid grid-cols-1 md:grid-cols-[58%_42%] min-h-[calc(100vh-80px)]">
        ...
        <div
          className="flex flex-col justify-center py-12 px-6 md:py-16 md:px-14"
          style={{ backgroundColor: "var(--raw-linen)" }}
        >
          <span
            className="uppercase text-[0.85rem] font-semibold tracking-[0.2em] mb-4"
          ...
          <p
            className="text-base mb-9 max-w-[480px] leading-[1.7]"
            style={{ color: "#4A4A4A" }}
          >
            {t("hero.intro")}
          </p>
